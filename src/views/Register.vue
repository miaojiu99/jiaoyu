    ...
    <div class="theme-padding">
      ...
      <main>
        <van-cell-group style="margin-top: 2rem;">
          <van-field left-icon="comm iconfont iconyiliaohangyedeICON-"  v-model="userphone" placeholder="请输入手机号"></van-field>
          ...
          <van-field type="password" v-model="password" left-icon="comm iconfont iconsuo"  placeholder="请输入新密码"></van-field>
          <van-field type="password" v-model="confpassword" left-icon="comm iconfont iconsuo"  placeholder="请确认密码"></van-field>
        </van-cell-group>
        <br />
        <br />
